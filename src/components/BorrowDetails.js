...
function BorrowDetails() {
  ...
  const [selectedImage, setSelectedImage] = useState(initialBooks[0].images[0]);
  ...
  // Filter similar books based on the type
      ...
      <div className="upper-section">
        ...
        <div className="right-section">
          <div className="cost-area">
            ...
            <button className="buy-button">Borrow Now</button>
          ...
          {similarBooks.length > 0 ? (
            similarBooks.map(similarBook => (
              <div key={similarBook.id} className="book-item">
                <img src={similarBook.images[0]} alt={similarBook.title} />
