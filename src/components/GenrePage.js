...
function GenrePage() {
  const { option } = useParams(); // Retrieve the genre from the URL params
  ...
  const filteredBooks = books.filter(book => book.price >= minPrice && book.price <= maxPrice); // You can filter books by genre if needed
    ...
    <div className="buy-page">
      <div className="content">
        ...
        <div className="book-section">
          <h1>{option} Books</h1> {/* Display the genre from the URL */}
